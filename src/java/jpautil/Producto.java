...
public class Producto implements Serializable {
    ...
    private Collection<Punto> puntoCollection;
    ...
    @XmlTransient
    public Collection<Punto> getPuntoCollection() {
        return puntoCollection;
    }

    public void setPuntoCollection(Collection<Punto> puntoCollection) {
        this.puntoCollection = puntoCollection;
    }
